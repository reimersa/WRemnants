...
impact_labels = {
    ...
    "scetlibNPgammaEigvar1": "SCETLib γ (eig. 1)",
    "scetlibNPgammaEigvar2": "SCETLib γ (eig. 2)",
    "scetlibNPgammaEigvar3": "SCETLib γ (eig. 3)",
    "scetlibNPgammalambda2nu": "SCETLib γ (λ<sup>2</sup><sub>ν</sub>)",
    "scetlibNPgammalambda4nu": "SCETLib γ (λ<sup>4</sup><sub>ν</sub>)",
    "scetlibNPgammalambdainfnu": "SCETLib γ (Δλ<sup>inf</sup><sub>ν</sub>)",
    ...
    "chargeVgenNP0scetlibNPZLambda4": "SCETLib λ<sup>4</sup>(Z)",
    "chargeVgenNP0scetlibNPZlambda4": "SCETLib λ<sup>4</sup>(Z)",
